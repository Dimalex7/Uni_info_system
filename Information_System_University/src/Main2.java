...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		// Dimiourgia antikeimenwn ka8hghtwn me th bohtheia twn sta8erwn pinakwn h.
	     Teacher t1 = new Teacher("Georgios Xatzinikolaou",h1,5);
	     ...
	     Teacher t5 = new Teacher("Theodoros Giourhs",h5,5);
	     
	     //Dimiourgia mias dynamikhs listas pou periexdi kai tous 5 ka8hghtes.
